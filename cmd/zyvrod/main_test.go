...
func TestAPIRequiresToken(t *testing.T) {
	...
	cases := []struct {
		...
		{http.MethodGet, "/api/batches/" + localstore.NewID()},
		{http.MethodPost, "/api/batches/" + localstore.NewID() + "/retry"},
		{http.MethodPost, "/api/batches/" + localstore.NewID() + "/cancel"},
		{http.MethodGet, "/api/workflows/" + localstore.NewID() + "/batches"},
